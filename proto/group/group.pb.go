...
const file_proto_group_group_proto_rawDesc = "" +
	"\n" +
	"\x17proto/group/group.proto\x12\fmychat.group\x1a\x13proto/msg/msg.proto\"B\n" +
	"\x10AddFriendRequest\x12\x18\n" +
	"\afromUid\x18\x01 \x01(\x03R\afromUid\x12\x14\n" +
	"\x05toUid\x18\x02 \x01(\x03R\x05toUid\"-\n" +
	"\x11AddFriendResponse\x12\x18\n" +
	"\agroupId\x18\x01 \x01(\tR\agroupId\"a\n" +
	"\x13HandleFriendRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x03R\x06userId\x12\x18\n" +
	"\agroupId\x18\x02 \x01(\tR\agroupId\x12\x18\n" +
	"\aisAgree\x18\x03 \x01(\bR\aisAgree\"0\n" +
	"\x14HandleFriendResponse\x12\x18\n" +
	"\agroupId\x18\x01 \x01(\tR\agroupId\"0\n" +
	"\x14GroupUserListRequest\x12\x18\n" +
	"\agroupId\x18\x01 \x01(\tR\agroupId\"+\n" +
	"\x15GroupUserListResponse\x12\x12\n" +
	"\x04list\x18\x01 \x03(\x03R\x04list\".\n" +
	"\x14UserGroupListRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x03R\x06userId\"+\n" +
	"\x15UserGroupListResponse\x12\x12\n" +
	"\x04list\x18\x01 \x03(\tR\x04list\"5\n" +
	"\x1bMessageGroupInfoListRequest\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\x03R\x06userId\"\x97\x01\n" +
	"\x10MessageGroupInfo\x12\x18\n" +
	"\agroupId\x18\x01 \x01(\tR\agroupId\x12\x1c\n" +
	"\taliasName\x18\x02 \x01(\tR\taliasName\x12\x1c\n" +
	"\tavatarUrl\x18\x03 \x01(\tR\tavatarUrl\x12-\n" +
	"\alastMsg\x18\x04 \x01(\v2\x13.mychat.msg.ChatMsgR\alastMsg\"R\n" +
	"\x1cMessageGroupInfoListResponse\x122\n" +
	"\x04list\x18\x01 \x03(\v2\x1e.mychat.group.MessageGroupInfoR\x04list2\xd5\x03\n" +
	"\vGroupClient\x12L\n" +
	"\tAddFriend\x12\x1e.mychat.group.AddFriendRequest\x1a\x1f.mychat.group.AddFriendResponse\x12U\n" +
	"\fHandleFriend\x12!.mychat.group.HandleFriendRequest\x1a\".mychat.group.HandleFriendResponse\x12X\n" +
	"\rGroupUserList\x12\".mychat.group.GroupUserListRequest\x1a#.mychat.group.GroupUserListResponse\x12X\n" +
	"\rUserGroupList\x12\".mychat.group.UserGroupListRequest\x1a#.mychat.group.UserGroupListResponse\x12m\n" +
	"\x14MessageGroupInfoList\x12).mychat.group.MessageGroupInfoListRequest\x1a*.mychat.group.MessageGroupInfoListResponseB\bZ\x06group/b\x06proto3"
...
var file_proto_group_group_proto_goTypes = []any{
	(*AddFriendRequest)(nil),             // 0: mychat.group.AddFriendRequest
	(*AddFriendResponse)(nil),            // 1: mychat.group.AddFriendResponse
	(*HandleFriendRequest)(nil),          // 2: mychat.group.HandleFriendRequest
	(*HandleFriendResponse)(nil),         // 3: mychat.group.HandleFriendResponse
	(*GroupUserListRequest)(nil),         // 4: mychat.group.GroupUserListRequest
	(*GroupUserListResponse)(nil),        // 5: mychat.group.GroupUserListResponse
	(*UserGroupListRequest)(nil),         // 6: mychat.group.UserGroupListRequest
	(*UserGroupListResponse)(nil),        // 7: mychat.group.UserGroupListResponse
	(*MessageGroupInfoListRequest)(nil),  // 8: mychat.group.MessageGroupInfoListRequest
	(*MessageGroupInfo)(nil),             // 9: mychat.group.MessageGroupInfo
	(*MessageGroupInfoListResponse)(nil), // 10: mychat.group.MessageGroupInfoListResponse
	(*msg.ChatMsg)(nil),                  // 11: mychat.msg.ChatMsg
}
var file_proto_group_group_proto_depIdxs = []int32{
	11, // 0: mychat.group.MessageGroupInfo.lastMsg:type_name -> mychat.msg.ChatMsg
	9,  // 1: mychat.group.MessageGroupInfoListResponse.list:type_name -> mychat.group.MessageGroupInfo
	0,  // 2: mychat.group.GroupClient.AddFriend:input_type -> mychat.group.AddFriendRequest
	2,  // 3: mychat.group.GroupClient.HandleFriend:input_type -> mychat.group.HandleFriendRequest
	4,  // 4: mychat.group.GroupClient.GroupUserList:input_type -> mychat.group.GroupUserListRequest
	6,  // 5: mychat.group.GroupClient.UserGroupList:input_type -> mychat.group.UserGroupListRequest
	8,  // 6: mychat.group.GroupClient.MessageGroupInfoList:input_type -> mychat.group.MessageGroupInfoListRequest
	1,  // 7: mychat.group.GroupClient.AddFriend:output_type -> mychat.group.AddFriendResponse
	3,  // 8: mychat.group.GroupClient.HandleFriend:output_type -> mychat.group.HandleFriendResponse
	5,  // 9: mychat.group.GroupClient.GroupUserList:output_type -> mychat.group.GroupUserListResponse
	7,  // 10: mychat.group.GroupClient.UserGroupList:output_type -> mychat.group.UserGroupListResponse
	10, // 11: mychat.group.GroupClient.MessageGroupInfoList:output_type -> mychat.group.MessageGroupInfoListResponse
